...
var BearerTokenVerifyProvider = /** @class */ (function () {
    function BearerTokenVerifyProvider() {
    }
    BearerTokenVerifyProvider.prototype.value = function () {
        var _this = this;
        return function (token) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                */
                return [2 /*return*/, jsonwebtoken_1.verify(token, 'kdskssdkdfs', {
                        issuer: 'sf'
                    })];
            });
        }); };
    };
    return BearerTokenVerifyProvider;
}());
