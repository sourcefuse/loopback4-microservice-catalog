import {UserStrategyProvider} from '../../providers';
...
describe('User Strategy provider', () => {
  let userStrategyProvider: UserStrategyProvider;
  ...
  it('return true if feature is enabled at User level', async () => {
    const isEnabled = userStrategyProvider.value();
  ...
  function setUp() {
    ...
    userStrategyProvider = new UserStrategyProvider(strategyHelperService);
  }
});
