...
import { GoogleLoginController as JugglerGoogleLoginController } from '../google-login.controller';
export class GoogleLoginController  extends JugglerGoogleLoginController {
  constructor(
