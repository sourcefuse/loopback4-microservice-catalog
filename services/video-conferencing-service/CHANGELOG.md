...
* fix(video-conferencing-service): post /session should returns json (#2105) ([e3524d2](https://github.com/sourcefuse/loopback4-microservice-catalog/commit/e3524d2)), closes [#2105](https://github.com/sourcefuse/loopback4-microservice-catalog/issues/2105) [#2087](https://github.com/sourcefuse/loopback4-microservice-catalog/issues/2087)


### BREAKING CHANGE

* post /session should returns json
...
* feat(video-conferencing-service): add sequelize support in video-conferncing service (#1809) ([4830926](https://github.com/sourcefuse/loopback4-microservice-catalog/commit/4830926)), closes [#1809](https://github.com/sourcefuse/loopback4-microservice-catalog/issues/1809) [#1350](https://github.com/sourcefuse/loopback4-microservice-catalog/issues/1350) [#1350](https://github.com/sourcefuse/loopback4-microservice-catalog/issues/1350)
...
* feat(video-conferencing-service): add audit log mixin in video conferencing service (#1388) ([d4879a3](https://github.com/sourcefuse/loopback4-microservice-catalog/commit/d4879a3)), closes [#1388](https://github.com/sourcefuse/loopback4-microservice-catalog/issues/1388) [#1368](https://github.com/sourcefuse/loopback4-microservice-catalog/issues/1368)
