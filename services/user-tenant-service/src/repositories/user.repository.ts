...
import {DefaultCrudRepository, juggler, repository, BelongsToAccessor, HasOneRepositoryFactory, HasManyRepositoryFactory} from '@loopback/repository';
import {User, UserRelations, Tenant, UserCredentials, UserTenant} from '../models';
...
UserRelations
> {
  public readonly defaultTenant: BelongsToAccessor<Tenant, typeof User.prototype.id>;
  ...
  protected userTenantRepositoryGetter: Getter<UserTenantRepository>, 
    ...
    this.defaultTenant = this.createBelongsToAccessorFor('defaultTenant', tenantRepositoryGetter,);
    this.registerInclusionResolver('defaultTenant', this.defaultTenant.inclusionResolver);
  }
}
