...
import {UserTenant, UserTenantRelations, UserLevelPermission, UserGroup, User, Tenant, Role, UserInvitation} from '../models';
...
> {
  ...
  public readonly userInvitations: HasManyRepositoryFactory<UserInvitation, typeof UserTenant.prototype.id>;
  ...
  constructor(
    ...
    this.registerInclusionResolver('userInvitations', this.userInvitations.inclusionResolver);
