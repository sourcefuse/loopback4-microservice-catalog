...
import {Tenant, TenantRelations, TenantConfig, UserTenant, User, Role, Group} from '../models';
...
> {
  ...
  public readonly roles: HasManyRepositoryFactory<Role, typeof Tenant.prototype.id>;

  public readonly groups: HasManyRepositoryFactory<Group, typeof Tenant.prototype.id>;
