...
export namespace WorkflowServiceBindings {
  ...
  export const RegisterWorkerFunction = BindingKey.create<WorkerRegisterFn | null>(
    `${BINDING_PREFIX}.workflow.worker.register`,
  );
  export const WorkerImplementationFunction = BindingKey.create<WorkerImplementationFn | null>(
