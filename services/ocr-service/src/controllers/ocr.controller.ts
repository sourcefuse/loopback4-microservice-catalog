...
export class OcrController {
  ...
  async getContractDocumentType(
    ...
    await this.requestProvider.sendRequest(
      `/contract-parser/document-type?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractTerminationClause(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/termination-clause?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractIprOwnershipClause(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/ipr-ownership-clause?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractWarrantyClause(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/warranty-clause?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractThirdPartyBeneficiary(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/third-party-beneficiary?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractGoverningLaw(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/governing-law?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractValidityTerms(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/validity-terms?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractLiquidityDamages(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/liquidity-damages?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractLimitedLiability(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/limited-liability?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractLegalId(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/legal_id?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractSignatoryDetails(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/signatory_details?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractVendor(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/vendor?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractPaymentTerms(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/payment_terms?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractForceMajeure(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/force-majeure?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractIndemnityClause(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/indemnity-clause?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractAutoRenewal(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/auto-renewal?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractCurrency(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/currency?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractPublicAnnouncement(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/public-announcement?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractAssignment(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/assignment?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractSupport(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/support?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractContractAmount(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/contract-amount?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractSlaClause(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/sla-clause?contract_name=${contract.contractName}`,
      'POST',
    );
  ...
  async getContractSlaDashboard(
    ...
    const contract = await this.contractRepository.findById(id);
    await this.requestProvider.sendRequest(
      `/contract-parser/sla-dashboard?contract_name=${contract.contractName}`,
      'POST',
    );
