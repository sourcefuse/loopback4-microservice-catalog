CREATE TABLE surveys (
    ...
    is_periodic_reassessment TINYINT(1) DEFAULT FALSE,
    recurrence_frequency ENUM('Annually', 'Biannually', 'Monthly', 'Quarterly') NULL,
    recurrence_end_date DATE NULL,
    recurrence_end_after_occurrences INT NULL,
