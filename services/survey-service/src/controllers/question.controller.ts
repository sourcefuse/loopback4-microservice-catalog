...
export class QuestionController {
  ...
  @authorize({
    permissions: [PermissionKey.CreateQuestion],
  })
  @post(basePath)
  ...
  @authorize({
    permissions: [PermissionKey.ViewQuestion],
  })
  @get(`${basePath}/count`)
  @response(STATUS_CODE.OK, {
  ...
  @authorize({
    permissions: [PermissionKey.UpdateQuestion],
  })
  @patch(basePath)
  @response(STATUS_CODE.OK, {
  ...
  @authorize({
    permissions: [PermissionKey.DeleteQuestion],
  })
  @del(`${basePath}/{id}`)
  @response(STATUS_CODE.NO_CONTENT, {
