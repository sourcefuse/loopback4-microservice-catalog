...
export class TemplateQuestionController {
  ...
  @authorize({
    permissions: [PermissionKey.CreateTemplateQuestion],
  })
  @post(basePath)
  ...
  async create(
    ...
    try {
      ...
      this.updateModifiedBy(templateId).catch(error => {
  ...
  @authorize({
    permissions: [PermissionKey.ViewTemplateQuestion],
  })
  @get(`${basePath}/count`)
  @response(STATUS_CODE.OK, {
  ...
  @authorize({
    permissions: [PermissionKey.UpdateTemplateQuestion],
  })
  @patch(basePath, {
  ...
  async updateById(
    ...
    this.updateModifiedByaAndAddUpdateLog(templateId).catch(error => {
      throw new Error(error);
    });
  }
  ...
  @authorize({
    permissions: [PermissionKey.DeleteTemplateQuestion],
  })
  @del(`${basePath}/{id}`)
  @response(STATUS_CODE.NO_CONTENT, {
  ...
  async deleteById(
    ...
    this.updateModifiedByaAndAddDeleteLog(templateId)
      .then()
      .catch(error => {
        throw new Error(error);
      });
