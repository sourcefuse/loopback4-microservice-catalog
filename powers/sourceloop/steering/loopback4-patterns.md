...
- `SoftDeleteEntity` – Adds soft-delete support via `deleted`, `deletedOn`, `deletedBy`
- `BaseEntity` – Extends `SoftDeleteEntity`; adds `createdOn`, `modifiedOn`
- `UserModifiableEntity` – Extends `BaseEntity`; adds `createdBy`, `modifiedBy`
