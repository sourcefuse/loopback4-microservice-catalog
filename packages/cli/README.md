...
_See code: [src/commands/extension.ts](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/v3.0.9/src/commands/extension.ts)_
...
_See code: [src/commands/microservice.ts](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/v3.0.9/src/commands/microservice.ts)_
...
_See code: [src/commands/scaffold.ts](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/v3.0.9/src/commands/scaffold.ts)_
