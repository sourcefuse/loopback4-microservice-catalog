...
@sourceloop/cli/1.2.1 linux-x64 node-v16.14.2
$ sl --help [COMMAND]
USAGE
  $ sl COMMAND
...
...
_See code: [src/commands/extension.ts](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/v1.2.1/src/commands/extension.ts)_
...
_See code: [src/commands/microservice.ts](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/v1.2.1/src/commands/microservice.ts)_
...
_See code: [src/commands/scaffold.ts](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/v1.2.1/src/commands/scaffold.ts)_
<!-- commandsstop -->
