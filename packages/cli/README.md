...
@sourceloop/cli/2.0.3 linux-x64 node-v16.13.0
$ sl --help [COMMAND]
USAGE
  $ sl COMMAND
...
...
_See code: [src/commands/extension.ts](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/v2.0.3/src/commands/extension.ts)_
...
_See code: [src/commands/microservice.ts](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/v2.0.3/src/commands/microservice.ts)_
...
_See code: [src/commands/scaffold.ts](https://github.com/sourcefuse/loopback4-microservice-catalog/blob/v2.0.3/src/commands/scaffold.ts)_
<!-- commandsstop -->
