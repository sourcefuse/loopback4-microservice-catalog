import { DeleteStateCommand, DeleteTourCommand, LoadStateCommand, LoadTourCommand, SaveStateCommand, SaveTourCommand } from "../commands";
import { Observable, of } from "rxjs";
import { DeleteStateParameters, DeleteTourParameters, FilterFunction, LoadStateParameters, SaveStateParameters, Status, Tour, TourState } from "../models";
import { TourStoreServiceService } from "../public-api";
...
export function filterFn(tourSteps) {
    return tourSteps;
};
